    ...
    public static class TextBoxBehavior
    {
        ...
        public readonly static DependencyProperty MinValueProperty =
                  DependencyProperty.RegisterAttached(
                      ...
                      new FrameworkPropertyMetadata(Double.MinValue, Changed));

        private static void Changed(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            MinVal = GetMinValue(d);
        ...
        public static double GetMinValue(DependencyObject element)
        {
            return (double)element.GetValue(MinValueProperty);
        }

        public static void SetMinValue(DependencyObject element, double value)
        {
        ...
        [AttachedPropertyBrowsableForType(typeof(TextBox))]
        public static double GetMaxValue(DependencyObject element)
        {
            return (double)element.GetValue(MaxValueProperty);
        }

        public static void SetMaxValue(DependencyObject element, double value)
        {
