...
namespace WpfEx.AttachedBehaviors
{
    ...
    { 
        ...
        public static bool IsValid(string text) 
        {
            ...
            if (text == NumberDecimalSeparator || 
                text == _numbersFormat.Value.NegativeSign || 
                text == _numbersFormat.Value.PositiveSign || 
                text == _numbersFormat.Value.NegativeSign + NumberDecimalSeparator || 
                text == _numbersFormat.Value.PositiveSign + NumberDecimalSeparator) 
                return true;
            ...
            int separatorCount = CountOccurances(text, NumberDecimalSeparator); 
            ...
            string textWithoutNumbersSeparator = RemoveFirstOccurrance(text, NumberDecimalSeparator);
